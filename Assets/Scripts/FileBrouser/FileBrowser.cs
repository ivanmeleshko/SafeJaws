...
namespace FileBrowser
{
    ...
    public class FileBrowser
    {
        ...
        public Texture2D
            fileTexture, directoryTexture, backTexture, driveTexture; //textures used to represent file types
        ...
        public bool draw()
        {
            ...
            switch (layout)
            {
                case 0:
                    ...
                    {
                        fileNameSelected = currentDirectory.FullName;
                        return true;
                    }
        ...
        protected void searchFileList(DirectoryInfo di, bool hasTexture)
        {
            ...
            FileInfo[] fia =
                di.GetFiles((searchBarString.IndexOf("*") >= 0) ? searchBarString : "*" + searchBarString + "*",
