...
namespace Colors
{
    public class CUIColorPicker : MonoBehaviour
    {
        ...
        public void SetOnValueChangeCallback(Action<ModelType, Color> onValueChange)
        {
        ...
        {
            _onValueChange.Execute(_modelType, Color);
        }

        private Color _color = Color.red;
        private Action<ModelType, Color> _onValueChange;
        ...
        private void Setup(Color inputColor)
        {
            ...
            Action applySaturationValue = () =>
            {
                ...
                {
                    _onValueChange.Execute(_modelType, resultColor);
                    _color = resultColor;
                }
            };
            applyHue();
